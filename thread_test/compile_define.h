...
#define WHEEL_DIRECTION_REVERT     (0)      // 0: 使编码器增加方向与车前进方向相同
                                            // 1: 使编码器增加方向与车前进方向相反
#elif BOARD_VER == VERC
#define WHEEL_LEFT_CA_PIN_NAME     (IOT_IO_NAME_GPIO_10)
#define WHEEL_LEFT_CA_PIN_FUNC     (IOT_IO_FUNC_GPIO_10_GPIO)
#define WHEEL_LEFT_CB_PIN_NAME     (IOT_IO_NAME_GPIO_13)
#define WHEEL_LEFT_CB_PIN_FUNC     (IOT_IO_FUNC_GPIO_13_GPIO)
#define WHEEL_RIGHT_CA_PIN_NAME    (IOT_IO_NAME_GPIO_9)
#define WHEEL_RIGHT_CA_PIN_FUNC    (IOT_IO_FUNC_GPIO_9_GPIO)
#define WHEEL_RIGHT_CB_PIN_NAME    (IOT_IO_NAME_GPIO_8)
#define WHEEL_RIGHT_CB_PIN_FUNC    (IOT_IO_FUNC_GPIO_8_GPIO)
#define WHEEL_DIRECTION_REVERT     (0)      // 0: 使编码器增加方向与车前进方向相同
                                            // 1: 使编码器增加方向与车前进方向相反
#endif
#endif